...
public class Parameters {
    ...
    public String toString() {
        return "Parameters{" + "parametersMatrix=" + parametersMatrix + ", parametersExpect=" + parametersExpect + ", parametersInclude=" + parametersInclude + ", parametersScMatch=" + parametersScMatch + ", parametersScMismatch=" + parametersScMismatch + ", parametersGapOpen=" + parametersGapOpen + ", parametersGapExtend=" + parametersGapExtend + ", parametersFilter=" + parametersFilter + ", parametersPattern=" + parametersPattern + ", parametersEntrezQuery=" + parametersEntrezQuery + '}';
    }
}
