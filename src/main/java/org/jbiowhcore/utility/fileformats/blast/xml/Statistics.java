...
public class Statistics {
    ...
    public String toString() {
        return "Statistics{" + "statisticsDbNum=" + statisticsDbNum + ", statisticsDbLen=" + statisticsDbLen + ", statisticsHspLen=" + statisticsHspLen + ", statisticsEffSpace=" + statisticsEffSpace + ", statisticsKappa=" + statisticsKappa + ", statisticsLambda=" + statisticsLambda + ", statisticsEntropy=" + statisticsEntropy + '}';
    }
}
