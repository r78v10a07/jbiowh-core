...
public class BlastOutput {
     ...
     *
     * @param value allowed object is {@link BlastOutputParam }
     *
     */
     ...
     *
     * @param value allowed object is {@link BlastOutputIterations }
     *
     */
     ...
     *
     * @param value allowed object is {@link BlastOutputMbstat }
     *
     */
    ...
    public String toString() {
        return "BlastOutput{" 
                + "blastOutputProgram=" + blastOutputProgram 
                + ", blastOutputVersion=" + blastOutputVersion 
                + ", blastOutputReference=" + blastOutputReference 
                + ", blastOutputDb=" + blastOutputDb 
                + ", blastOutputQueryID=" + blastOutputQueryID 
                + ", blastOutputQueryDef=" + blastOutputQueryDef 
                + ", blastOutputQueryLen=" + blastOutputQueryLen 
                + ", blastOutputQuerySeq=" + blastOutputQuerySeq + "\n"
                + ", blastOutputParam=" + blastOutputParam  + "\n"
                + ", blastOutputIterations=" + blastOutputIterations  + "\n"
                + ", blastOutputMbstat=" + blastOutputMbstat + '}';
    }
}
