...
public class Hsp {
    ...
    public String toString() {
        return "Hsp{" + "hspNum=" + hspNum + ", hspBitScore=" + hspBitScore + ", hspScore=" + hspScore + ", hspEvalue=" + hspEvalue + ", hspQueryFrom=" + hspQueryFrom + ", hspQueryTo=" + hspQueryTo + ", hspHitFrom=" + hspHitFrom + ", hspHitTo=" + hspHitTo + ", hspPatternFrom=" + hspPatternFrom + ", hspPatternTo=" + hspPatternTo + ", hspQueryFrame=" + hspQueryFrame + ", hspHitFrame=" + hspHitFrame + ", hspIdentity=" + hspIdentity + ", hspPositive=" + hspPositive + ", hspGaps=" + hspGaps + ", hspAlignLen=" + hspAlignLen + ", hspDensity=" + hspDensity + ", hspQseq=" + hspQseq + ", hspHseq=" + hspHseq + ", hspMidline=" + hspMidline + '}';
    }
}
